...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GenericCollectionView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC21GenericCollectionView21GenericCollectionView")
@interface GenericCollectionView : UIView
...
@interface GenericCollectionView (SWIFT_EXTENSION(GenericCollectionView)) <UICollectionViewDataSource>
...
@interface GenericCollectionView (SWIFT_EXTENSION(GenericCollectionView)) <UICollectionViewDelegateFlowLayout>
